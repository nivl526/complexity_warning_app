class UnifiedFeatureExtractor:
    ...
    def calculate_similar_color_features(self, features):
        """Calculates the number of items with common colors between the board and goal, for color_1 and color_2."""
        similar_color_1 = 0
        similar_color_2 = 0
        ...
        for color in self.color_labels:
            ...
            goal_val_1 = features.get(goal_key_1, 0)
            board_val_1 = features.get(board_key_1, 0)
            goal_val_2 = features.get(goal_key_2, 0)
            board_val_2 = features.get(board_key_2, 0)

            if goal_val_1 > 0 and board_val_1 > 0:
                similar_color_1 += goal_val_1 + board_val_1

            if goal_val_2 > 0 and board_val_2 > 0:
                similar_color_2 += goal_val_2 + board_val_2
